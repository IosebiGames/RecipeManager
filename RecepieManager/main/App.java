...
public class App {
	...
	public RoundButton[] buttons = {
			new RoundButton("Burgers:"),
			new RoundButton("Steak:"),
			new RoundButton("Ice-Cream:"),
			new RoundButton("Chicken Salad:"),
			new RoundButton("Tomato Salad:"),
			new RoundButton("Next"),
			new RoundButton("More")
	};
